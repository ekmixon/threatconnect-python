...
def main():
    ...
    if enable_example1:
        """ This is a basic example that pull all threats for the default org. """
    ...
    if enable_example3:
        """ This example adds a filter to pull an threat by id. """
        # optionally set max results
        tc.set_api_result_limit(500)
    ...
    if enable_example4:
        """ This example adds a filter with multiple sub filters.  This request
            will return any threats that matches any filters. """
    ...
    if enable_example5:
        """ This example adds multiple filters to limit the result set.  This request
            will return only threats that match all filters. """
