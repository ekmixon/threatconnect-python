...
def g_properties(group_uri):
    ...
    return {
        'add': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}',
        },
        'association_groups': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/groups',
        },
        'association_group_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/groups/{1}/{2}',
        },
        ...
        'association_indicators': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/indicators',
        },
        'association_indicator_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': '/v2/indicators/{0}/{1}/groups/'
            + group_uri
            + '/{2}',  # indicator type, indicator_value
        },
        ...
        'association_tasks': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/tasks',
        },
        'association_task_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/tasks/{1}',
        },
        ...
        'association_victims': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/victims',
        },
        'association_victim_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/victims/{1}',
        },
        ...
        'attributes': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/attributes',
        },
        'attribute_add': {
            'http_method': 'POST',
            'owner_allowed': True,
        ...
        'attribute_delete': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/attributes/{1}',
        },
        'attribute_update': {
            'http_method': 'PUT',
            'owner_allowed': True,
        ...
        'groups': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': '/v2/groups/{0}/{1}/groups/'
            + group_uri,  # group type, group id
        },
        'id': {
            'http_method': 'GET',
            'owner_allowed': True,
        ...
        'security_label_add': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/securityLabels/{1}',
        },
        ...
        'security_label_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/securityLabels',
        },
        'security_labels': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': '/v2/securityLabels/{0}/groups/'
            + group_uri,  # security labels
        },
        'tag_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/tags/{1}',
        },
        'tag_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
        ...
        'tags_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/groups/{group_uri}' + '/{0}/tags',
        },
        'tasks': {
            'http_method': 'GET',
            'owner_allowed': True,
...
def i_properties(indicator_uri):
    ...
    properties = {
        'add': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}',
        },
        'association_groups': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/groups',
        },
        'association_group_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/groups/{1}/{2}',
        },
        'association_group_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
        ...
        'association_indicators': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/indicators',
        },
        'association_tasks': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/tasks',
        },
        'association_task_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/tasks/{1}',
        },
        'association_task_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/tasks/{1}/{2}',
        },
        'association_victims': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/victims',
        },
        'attributes': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/attributes',
        },
        'attribute_add': {
            'http_method': 'POST',
            'owner_allowed': True,
        ...
        'attribute_delete': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/attributes/{1}',
        },
        'attribute_update': {
            'http_method': 'PUT',
            'owner_allowed': True,
        ...
        'delete': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}',
        },
        'false_positive_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/falsePositive',
        },
        'filters': [
            'add_adversary_id',
            'add_campaign_id',
        ...
        'groups': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': '/v2/groups/{0}/{1}/indicators/'
            + indicator_uri,  # group type, group value
        },
        'indicator': {
            'http_method': 'GET',
            'owner_allowed': True,
        ...
        'observation_count_get': {
            ...
            'owner_allowed': False,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/observationCount',
        },
        'observations_get': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/observations',
        },
        'observations_add': {
            'http_method': 'POST',
            'owner_allowed': False,
        ...
        'security_label_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/securityLabels',
        },
        'security_labels': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': '/v2/securityLabels/{0}/indicators/'
            + indicator_uri,  # security labels
        },
        'tag_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/tags/{1}',
        },
        'tag_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
        ...
        'tags_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/indicators/{indicator_uri}' + '/{0}/tags',
        },
        'tasks': {
            'http_method': 'GET',
            'owner_allowed': True,
...
def custom_i_properties(api_branch):
    ...
    return {
        'add': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}',
        },
        'association_groups': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/groups',
        },
        'association_indicators': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/indicators',
        },
        'attributes': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/attributes',
        },
        'attribute_add': {
            'http_method': 'POST',
            'owner_allowed': True,
        ...
        'attribute_delete': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/attributes/{1}',
        },
        'attribute_update': {
            'http_method': 'PUT',
            'owner_allowed': True,
        ...
        'delete': {
            ...
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}',
        },
        'false_positive_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/falsePositive',
        },
        'filters': [
            'add_adversary_id',
            'add_campaign_id',
        ...
        'observation_count_get': {
            ...
            'owner_allowed': False,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/observationCount',
        },
        'observations_get': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/observations',
        },
        'observations_add': {
            'http_method': 'POST',
            'owner_allowed': False,
        ...
        'security_label_add': {
            ...
            'owner_allowed': True,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/securityLabels/{1}',
        },
        'security_label_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
        ...
        'security_label_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/securityLabels',
        },
        'security_labels': {
            'http_method': 'GET',
            'owner_allowed': True,
            'pagination': True,
            'uri': '/v2/securityLabels/{0}/indicators/'
            + api_branch,  # security labels
        },
        'tag_add': {
            'http_method': 'POST',
            'owner_allowed': True,
            'pagination': False,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/tags/{1}',
        },
        'tag_delete': {
            'http_method': 'DELETE',
            'owner_allowed': True,
        ...
        'tags_load': {
            ...
            'owner_allowed': False,
            'pagination': True,
            'uri': f'/v2/indicators/{api_branch}' + '/{0}/tags',
        },
        'type_get': {
            'http_method': 'GET',
            'owner_allowed': False,
